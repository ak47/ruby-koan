...
class AboutMessagePassing < EdgeCase::Koan
  ...
  def test_methods_can_be_invoked_more_dynamically
    ...
    assert_equal true, mc.send("caught?")
    assert_equal true, mc.send("caught" + '?' )    # What do you need to add to the first string?
    assert_equal true, mc.send("CAUGHT?".downcase )      # What would you need to do to the string?
  end
